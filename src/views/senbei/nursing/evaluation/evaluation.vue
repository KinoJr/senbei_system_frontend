  ...
  <el-drawer v-model="drawerShow" direction="rtl" size="95%" style="max-width: 800px;" :destroy-on-close="true" @close="onclose">
    <template #header>
      <el-menu :default-active="activeIndex" mode="horizontal" @select="handleSelect" :ellipsis="false">
        ...
        <el-menu-item index="2" :disabled="archivalType === 'b'"> 婴儿出馆评估 </el-menu-item>
      </el-menu>
    ...
    <template #default>
      <ul class="infinite-list" style="overflow: auto">
        <el-card style="width: 100%">
          ...
          <div>
            <Momform v-if="activeIndex === '1' && momDatas" :datas="momDatas" :info="archivalInfo" :roomOptions="props.roomOptions" @onOk="getList()" />

            <Babyform v-if="activeIndex === '2' && stepList[active]" :key="active" :datas="stepList[active].args" :info="archivalInfo" @onOk="getList()" @onDel="delBaby" />
          </div>
        </el-card>
      </ul>
    </template>
    <template #footer>
      ...
      <div style="flex: auto">
        ...
        <el-button v-if="stepList.length > 1 && active > 0 && activeIndex === '2' " type="primary" @click="previousPage">上一页</el-button>
