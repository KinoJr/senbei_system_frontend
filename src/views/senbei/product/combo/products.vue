<template>
    <el-drawer v-model="drawerShow" title="产品/服务" direction="rtl" size="95%" style="max-width: 800px;"
        ...
        <el-row :gutter="40" class="panel-group">
            <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col" v-for="(item, index) in dataList" :key="index">
    ...
    <el-dialog :title="productName" v-model="open" width="90%" style="max-width: 800px;" append-to-body
        ...
        <div v-show="form.specId">
            <el-divider content-position="left">规格详情</el-divider>
            <el-row :gutter="40" class="panel-group">
                <el-col :span="24">
...
function getCategory() {
    listProductCategory({ pageNum: 1, pageSize: 50, productCategoryStatus: '1' }).then(response => {
        if (response.rows) {
